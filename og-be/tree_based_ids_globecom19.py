...
def main(filename="https://raw.githubusercontent.com/Western-OC2-Lab/Intrusion-Detection-System-Using-Machine-Learning/main/data/CICIDS2017_sample.csv", alg_to_run="all", xgb_learning_rate=0.1, xgb_max_depth=3, xgb_n_estimators=100, xgb_colsample_bytree=1, xgb_min_child_weight=1,
    ...
    processed_time = processed_end_time - processed_start_time
    processed_time_2 = processed_end_2 - processed_start_2
    ...
    total_time = dt_execution_time + rf_execution_time + et_execution_time + xg_execution_time + stk_execution_time + dt_feat_execution_time + rf_feat_execution_time + et_feat_execution_time + xg_feat_execution_time + stk_feat_execution_time + processed_time + processed_time_2
    ...
    if alg_to_run == "decision tree":
        ...
        print('F1-score of DT: ' + str(fscore))
        print('All F1-scores of DT: ', dt_fscores)
        print('Execution time of DT: ' + str(dt_execution_time + processed_time) + ' seconds')
        total_execution_time = dt_execution_time + processed_time
        return dt_score, precision, recall, fscore, dt_fscores, total_execution_time
        ...
        print('F1-score of RF: ' + str(fscore))
        print('All F1-scores of RF: ', rf_fscores)
        print('Execution time of RF: ' + str(rf_execution_time + processed_time) + ' seconds')
        total_execution_time = rf_execution_time + processed_time
        return rf_score, precision, recall, fscore, rf_fscores, total_execution_time
        ...
        print('F1-score of ET: ' + str(fscore))
        print('All F1-scores of ET: ', et_fscores)
        print('Execution time of ET: ' + str(et_execution_time + processed_time) + ' seconds')
        total_execution_time = et_execution_time + processed_time
        return et_score, precision, recall, fscore, et_fscores, total_execution_time
        ...
        print('F1-score of XGBoost: ' + str(fscore))
        print('All F1-scores of XGBoost: ', xg_fscores)
        print('Execution time of XGBoost: ' + str(xg_execution_time + processed_time) + ' seconds')
        total_execution_time = xg_execution_time + processed_time
        return xg_score, precision, recall, fscore, xg_fscores, total_execution_time
        ...
        print('F1-score of Stacking: ' + str(fscore))
        print('All F1-scores of Stacking: ', stk_fscores)
        print('Execution time of Stacking: ' + str(stk_execution_time + processed_time) + ' seconds')
        total_execution_time = stk_execution_time + processed_time
        return stk_score, precision, recall, fscore, stk_fscores, total_execution_time
        ...
        print('F1-score of DT w/ Feature Selection: ' + str(fscore))
        print('All F1-scores of DT w/ Feature Selection: ', dt_feat_fscores)
        print('Execution time of DT w/ Feature Selection: ' + str(dt_feat_execution_time + processed_time + processed_time_2) + ' seconds')
        total_execution_time = dt_feat_execution_time + processed_time + processed_time_2
        return dt_feat_score, precision, recall, fscore, dt_feat_fscores, total_execution_time
        ...
        print('F1-score of RF w/ Feature Selection: ' + str(fscore))
        print('All F1-scores of RF w/ Feature Selection: ', rf_feat_fscores)
        print('Execution time of RF w/ Feature Selection: ' + str(rf_feat_execution_time + processed_time + processed_time_2) + ' seconds')
        total_execution_time = rf_feat_execution_time + processed_time + processed_time_2
        return rf_feat_score, precision, recall, fscore, rf_feat_fscores, total_execution_time
        ...
        print('F1-score of ET w/ Feature Selection: ' + str(fscore))
        print('All F1-scores of ET w/ Feature Selection: ', et_feat_fscores)
        print('Execution time of ET w/ Feature Selection: ' + str(et_feat_execution_time + processed_time + processed_time_2) + ' seconds')
        total_execution_time = et_feat_execution_time + processed_time + processed_time_2
        return et_feat_score, precision, recall, fscore, et_feat_fscores, total_execution_time
        ...
        print('F1-score of XGBoost w/ Feature Selection: ' + str(fscore))
        print('All F1-scores of XGBoost w/ Feature Selection: ', xg_feat_fscores)
        print('Execution time of XGBoost w/ Feature Selection: ' + str(xg_feat_execution_time + processed_time + processed_time_2) + ' seconds')
        total_execution_time = xg_feat_execution_time + processed_time + processed_time_2
        return xg_feat_score, precision, recall, fscore, xg_feat_fscores, total_execution_time
        ...
        print('F1-score of Stacking w/ Feature Selection: ' + str(fscore))
        print('All F1-scores of Stacking w/ Feature Selection: ', stk_feat_fscores)
        print('Execution time of Stacking w/ Feature Selection: ' + str(stk_feat_execution_time + processed_time + processed_time_2) + ' seconds')
        total_execution_time = stk_feat_execution_time + processed_time + processed_time_2
        return stk_feat_score, precision, recall, fscore, stk_feat_fscores, total_execution_time
    else:
